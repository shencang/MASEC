        ...
        public void onClick(View v) {
            ...
            switch (v.getId()) {
                case R.id.addBtn: {
                    ...
                    addData(themeStr, contentStr, dateStr);
                ...
                case R.id.queryBtn: {
                    ...
                    Cursor cursor = queryData(themeStr, contentStr, dateStr);
...
//    }
    ...
    private void addData(String themeStr, String contentStr, String dateStr) {
    }
